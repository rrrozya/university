...
happyExpList = Happy_Data_Array.listArray (0,40) ([2816,2816,8192,4096,0,0,0,2816,2816,0,24576,2816,2816,0,1024,2816,0,0,0,4096,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseExpr","Expression","Disj","Conj","Neg","Var","IDENT","LEFTP","RIGHTP","NOT","AND","OR","IMPL","%eof"]
        bit_start = st * 16
        bit_end = (st + 1) * 16
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	Ident happy_dollar_dollar -> cont 9;
	LeftP -> cont 10;
	RightP -> cont 11;
	NotT -> cont 12;
	AndT -> cont 13;
